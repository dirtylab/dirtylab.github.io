...
Voir le fichier [`README.html`](README.html) pour la liste des principaux fichiers du projet et leurs rôles.
...
- Sélectionnez le fichier à modifier (par ex. [README.html](README.html))
