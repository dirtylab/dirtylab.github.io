...
Voir le fichier [`README.html`](https://github.com/sveinburne/lets-play-science/blob/master/README.html) pour la liste des principaux fichiers du projet et leurs rôles.
